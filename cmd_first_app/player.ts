export class Player{
    ...
    public describe(): string {
        return `ID: ${this.ID + " "}FirstName: ${this.FirstName+ " "}LastName: ${this.LastName+ " "}APT: ${this.APT+ " "}SET: ${this.SET+ " "}NationalAssociation: ${this.NationalAssociation+ " "}average: ${ (this.APT + this.SET) /2 +" "} position: ${this.position+ " "}`;
      }
