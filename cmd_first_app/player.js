...
var Player = /** @class */ (function () {
    ...
    Player.prototype.describe = function () {
        return "ID: ".concat(this.ID + " ", "FirstName: ").concat(this.FirstName + " ", "LastName: ").concat(this.LastName + " ", "APT: ").concat(this.APT + " ", "SET: ").concat(this.SET + " ", "NationalAssociation: ").concat(this.NationalAssociation + " ", "average: ").concat((this.APT + this.SET) / 2 + " ", " position: ").concat(this.position + " ");
    };
    return Player;
}());
