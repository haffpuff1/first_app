...
function create_new_player() {
    ...
    var ID = readline.question("Enter the player ID: ");
    ...
    var FirstName = readline.question('Enter the player First name: ');
    ...
    var LastName = readline.question('Enter the player Last Name: ');
    ...
    var APT = readline.question('Enter the player APT: ');
    while (APT === "" || isNaN(APT) || APT < 0 || APT > 100) {
        if (APT === "") {
    ...
    var SET = readline.question('Enter the player SET: ');
    while (SET === "" || isNaN(SET) || SET < 0 || SET > 100) {
        if (SET === "") {
    ...
    var NationalAssociation = readline.question('Enter the player National Association: ');
    ...
    var position = readline.question('Please enter the player position: ');
    while (position === "" ||
        ...
        else if (position.toLowerCase() !== "attacker" &&
            position.toLowerCase() !== "midfielder" &&
            position.toLowerCase() !== "defender") {
    ...
    var newPlayer = new player_1.Player(ID, FirstName, LastName, APT, SET, NationalAssociation, ((APT + SET) / 2), position);
